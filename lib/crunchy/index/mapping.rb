  ...
  class Index
    module Mapping
      ...
      module ClassMethods
        ...
        #
        def root(**options)
          self.root_object ||= Crunchy::Fields::Root.new(:root, **Crunchy.default_root_options.merge(options))
        ...
        def field(*args, **options, &block)
          if args.size > 1
            ...
            expand_nested(Crunchy::Fields::Base.new(args.first, **options), &block)
          end
        end
