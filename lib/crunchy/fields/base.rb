module Crunchy
  module Fields
    class Base
      ...
      attr_accessor :parent # used by Crunchy::Index::Mapping to expand nested fields
      ...
      def mappings_hash
        ...
        mapping.reverse_merge!(type: (children.present? ? 'object' : Crunchy.default_field_type))
    ...
    private
      ...
      def validate_join_type!(type)
        ...
        raise Crunchy::InvalidJoinFieldType.new(type, @name, options[:relations])
      end
