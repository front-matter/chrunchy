    ...
    class Parameters
      ...
      module QueryStorage
        ...
        class Bool
          ...
          #
          # @param other [Crunchy::Search::Parameters::QueryStorage::Bool]
          # @return [Crunchy::Search::Parameters::QueryStorage::Bool]
          def update(other)
            self.class.new(
        ...
        #
        # @see Crunchy::Search::QueryProxy#must
        ...
        # Pushes the passed query to the end of the array.
        #
        # @see Crunchy::Search::QueryProxy#should
        # @param other_value [Hash, Array] any acceptable storage value
        # @return [{Symbol => Array<Hash>}]
        ...
        # Pushes the passed query to the end of the array.
        #
        # @see Crunchy::Search::QueryProxy#must_not
        # @param other_value [Hash, Array] any acceptable storage value
        # @return [{Symbol => Array<Hash>}]
        ...
        # @param other [Crunchy::Search::Parameters::Storage] other storage
        # @return [{Symbol => Array<Hash>}]
        def merge!(other)
