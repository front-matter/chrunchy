require 'crunchy/index/adapter/orm'
    ...
    module Adapter
      ...
      private
        ...
        def cleanup_default_scope!
          if Crunchy.logger && (@default_scope.arel.orders.present? ||
             @default_scope.arel.limit.present? || @default_scope.arel.offset.present?)
            Crunchy.logger.warn('Default type scope order, limit and offset are ignored and will be nullified')
          end
