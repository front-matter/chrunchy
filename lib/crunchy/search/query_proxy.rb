module Crunchy
  module Search
    ...
    class QueryProxy
      ...
      # @param request [Crunchy::Search::Request] request instance for modification
      ...
      #   Executes {Crunchy::Search::Parameters::QueryStorage#must} in the scope
      #   of newly created request object.
      #
      #   @see Crunchy::Search::Parameters::QueryStorage#must
      ...
      #   Executes {Crunchy::Search::Parameters::QueryStorage#should} in the scope
      #   of newly created request object.
      #
      #   @see Crunchy::Search::Parameters::QueryStorage#should
      #   @return [Crunchy::Search::Request]
      #
      ...
      #   Executes {Crunchy::Search::Parameters::QueryStorage#must_not} in the scope
      #   of newly created request object.
      #
      #   @see Crunchy::Search::Parameters::QueryStorage#must_not
      #   @return [Crunchy::Search::Request]
      #
      ...
      #   Executes {Crunchy::Search::Parameters::QueryStorage#and} in the scope
      #   of newly created request object.
      #
      #   @see Crunchy::Search::Parameters::QueryStorage#and
      #   @return [Crunchy::Search::Request]
      #
      ...
      #       # => <PlacesIndex::Query {..., :body=>{:query=>{:bool=>{
      #       #      :must=>[{:bool=>{:must_not=>{:match=>{:name=>"Moscow"}}}}, {:match=>{:name=>"London"}}]}}}}>
      #     @param scope [Crunchy::Search::Request] other scope
      #
      #   @overload and
      #     If block is passed instead of a pure hash, `elasticsearch-dsl"
      #     gem will be used to process it.
      ...
      #   Executes {Crunchy::Search::Parameters::QueryStorage#or} in the scope
      #   of newly created request object.
      #
      #   @see Crunchy::Search::Parameters::QueryStorage#or
      #   @return [Crunchy::Search::Request]
      #
      ...
      #   Executes {Crunchy::Search::Parameters::QueryStorage#not} in the scope
      #   of newly created request object.
      #   The only difference from {#must_not} is that is accepts another scope additionally.
      #
      #   @see Crunchy::Search::Parameters::QueryStorage#not
      #   @return [Crunchy::Search::Request]
      #
      ...
      %i[and or not].each do |method|
        define_method method do |query_hash_or_scope = nil, &block|
          ...
          if !block && query_hash_or_scope.is_a?(Crunchy::Search::Request)
      ...
      # Executes {Crunchy::Search::Parameters::QueryStorage#minimum_should_match} in the scope
      # of newly created request object.
      #
      # @see Crunchy::Search::Parameters::QueryStorage#minimum_should_match
