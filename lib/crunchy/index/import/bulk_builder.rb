module Crunchy
  class Index
    module Import
      ...
      class BulkBuilder
        # @param index [Crunchy::Index] desired index
      ...
      private
        ...
        def crutches_for_index
          @crutches_for_index ||= Crunchy::Index::Crutch::Crutches.new @index, @to_index
        end
        ...
        def reindex_descendants(root)
          ...
          crutches = Crunchy::Index::Crutch::Crutches.new @index, [root, *descendants]
        ...
        def join_field_type(object)
          ...
          join_field_value = data_for(
            ...
            crutches: Crunchy::Index::Crutch::Crutches.new(@index, [raw_object])
          )[join_field]
