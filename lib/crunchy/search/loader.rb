  ...
  module Search
    ...
    class Loader
      ...
      def derive_index(index_name)
        ...
        raise Crunchy::UndefinedIndex, "Can not find index named `#{index}`" unless index
