require 'crunchy/index/adapter/base'
  ...
  class Index
    module Adapter
      ...
      class Object < Base
        ...
        # This method is used internally by `Crunchy::Index.import`.
        #
        ...
        #   end
        #
        # @see Crunchy::Index::Adapter::Base#import_fields
        ...
        #
        # @see Crunchy::Index::Adapter::Base#import_references
        ...
        # loader will return an array `Crunchy::Index` objects that actually was passed.
        #
