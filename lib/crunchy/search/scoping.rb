module Crunchy
  module Search
    # This module along with {Crunchy::Search} provides an ability to
    # use names scopes.
    #
    # @example
    ...
    module Scoping
      ...
      module ClassMethods
        # The scopes stack.
        #
        # @return [Array<Crunchy::Search::Request>] array of scopes
        def scopes
          Crunchy.current[:crunchy_scopes] ||= []
        end
      end
      ...
      #
      # @see Crunchy::Search::ClassMethods#all
