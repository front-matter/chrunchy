...
module Crunchy
  module Search
    ...
    # logic.
    #
    # @see Crunchy::Search::Request#parameters
    ...
    class Parameters
      ...
      #
      # @return [{Symbol => Crunchy::Search::Parameters::Storage}]
      def self.storages
        @storages ||= Hash.new do |hash, name|
          hash[name] = "Crunchy::Search::Parameters::#{name.to_s.camelize}".constantize
        end
      end
      ...
      #
      # @example
      #   Crunchy::Search::Parameters.new(limit: 10, offset 10)
      #   Crunchy::Search::Parameters.new(
      #     limit: Crunchy::Search::Parameters::Limit.new(10),
      #     limit: Crunchy::Search::Parameters::Offset.new(10)
      #   )
      # @param initial [{Symbol => Object, Crunchy::Search::Parameters::Storage}]
      ...
      # @return [Crunchy::Search::Parameters::Storage]
      ...
      # @return [{Symbol => Crunchy::Search::Parameters::Storage}] removed storages hash
      def only!(names)
      ...
      #
      # @param names [Array<String, Symbol>]
      # @return [{Symbol => Crunchy::Search::Parameters::Storage}] kept storages hash
      def except!(names)
        @storages.except!(*assert_storages(names))
      end

      # Takes all the storages and merges them one by one using
      # {Crunchy::Search::Parameters::Storage#merge!} method. Merging
      ...
      # "and" operation.
      #
      # @see Crunchy::Search::Parameters::Storage#merge!
      # @return [{Symbol => Crunchy::Search::Parameters::Storage}] storages from other parameters
      def merge!(other)
