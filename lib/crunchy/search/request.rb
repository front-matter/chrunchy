module Crunchy
  module Search
    ...
    # @see Crunchy::Search
    # @example
    #   scope = Crunchy::Search::Request.new(PlacesIndex)
    #   # => <Crunchy::Search::Request {:index=>["places"], :body=>{}}>
    #   scope.limit(20)
    #   # => <Crunchy::Search::Request {:index=>["places"], :body=>{:size=>20}}>
    #   scope.order(:name).offset(10)
    #   # => <Crunchy::Search::Request {:index=>["places"], :body=>{:sort=>["name"], :from=>10}}>
    class Request
      include Enumerable
      include Scoping
      include Scrolling
      ...
      # The class is initialized with the list of crunchy indexes,
      # which are later used to compose requests.
      # Any symbol/string passed is treated as an index identifier.
      #
      # @example
      #   Crunchy::Search::Request.new(:places)
      #   # => <Crunchy::Search::Request {:index=>["places"], :body=>{}}>
      #   Crunchy::Search::Request.new(PlacesIndex)
      #   # => <Crunchy::Search::Request {:index=>["places"], :body=>{}}>
      #   Crunchy::Search::Request.new(UsersIndex, PlacesIndex)
      #   # => <Crunchy::Search::Request {:index=>["users", "places"], :body=>{}}>
      # @param indexes [Array<Crunchy::Index, String, Symbol>] indexes
      ...
      #
      # @return [Crunchy::Search::Parameters]
      def parameters
      ...
      def ==(other)
        super || other.is_a?(Crunchy::Search::Request) ? compare_internals(other) : to_a == other
      end

      # Access to ES response wrappers providing useful methods such as
      # {Crunchy::Search::Response#total} or {Crunchy::Search::Response#max_score}.
      #
      # @see Crunchy::Search::Response
      # @return [Crunchy::Search::Response] a response object instance
      def response
      ...
      #   @see Crunchy::Search::Parameters::Query
      #   @return [Crunchy::Search::Request, Crunchy::Search::QueryProxy]
      #
      #   @overload query(query_hash)
      #     If pure hash is passed it goes straight to the `query` parameter storage.
      #     Acts exactly the same way as {Crunchy::Search::QueryProxy#must}.
      #
      ...
      #     @return [Crunchy::Search::Request]
      #
      #   @overload query
      #     If block is passed instead of a pure hash, `elasticsearch-dsl"
      #     gem will be used to process it.
      #     Acts exactly the same way as {Crunchy::Search::QueryProxy#must} with a block.
      #
      ...
      #     @return [Crunchy::Search::QueryProxy]
      #
      ...
      #   @see Crunchy::Search::Parameters::Filter
      #   @return [Crunchy::Search::Request, Crunchy::Search::QueryProxy]
      #
      ...
      #   @see Crunchy::Search::Parameters::PostFilter
      #   @return [Crunchy::Search::Request, Crunchy::Search::QueryProxy]
      #
      ...
      %i[query filter post_filter].each do |name|
        define_method name do |query_hash = UNDEFINED, &block|
          if block || query_hash != UNDEFINED
            ...
            Crunchy::Search::QueryProxy.new(name, self)
          end
        end
      end
      ...
      #   @see Crunchy::Search::Parameters::Order
      ...
      #   @see Crunchy::Search::Parameters::DocvalueFields
      ...
      # @see Crunchy::Search::Parameters::Indices
      # @see https://www.elastic.co/guide/en/elasticsearch/reference/current/search-search.html
      # @param values [Array<Crunchy::Index, String, Symbol>] index names
      # @return [Crunchy::Search::Request]
      ...
      #   @see Crunchy::Search::Parameters::TrackScores
      ...
      #     # => <PlacesIndex::Query {:index=>["places"]}>
      #   @see Crunchy::Search::Parameters::TrackTotalHits
      ...
      #     # => <PlacesIndex::Query {:index=>["places"]}>
      #   @see Crunchy::Search::Parameters::Explain
      ...
      #     # => <PlacesIndex::Query {:index=>["places"]}>
      #   @see Crunchy::Search::Parameters::Version
      #   @see https://www.elastic.co/guide/en/elasticsearch/reference/current/search-search.html
      #   @param value [true, false]
      #   @return [Crunchy::Search::Request]
      #
      ...
      #     # => <PlacesIndex::Query {:index=>["places"]}>
      #   @see Crunchy::Search::Parameters::Profile
      ...
      #     # => 0
      #   @see Crunchy::Search::Parameters::None
      ...
      #   @see Crunchy::Search::Parameters::RequestCache
      ...
      #   @see Crunchy::Search::Parameters::SearchType
      ...
      #   @see Crunchy::Search::Parameters::Preference
      ...
      #   @see Crunchy::Search::Parameters::Timeout
      ...
      #   @see Crunchy::Search::Parameters::Limit
      ...
      #   @see Crunchy::Search::Parameters::Offset
      #   @see https://www.elastic.co/guide/en/elasticsearch/reference/current/paginate-search-results.html
      #   @param value [String, Integer]
      #   @return [Crunchy::Search::Request]
      #
      ...
      #   @see Crunchy::Search::Parameters::IgnoreUnavailable
      ...
      #   @see Crunchy::Search::Parameters::Collapse
      ...
      #   @see Crunchy::Search::Parameters::Source
      ...
      #   @see Crunchy::Search::Parameters::StoredFields
      ...
      # @see Crunchy::Search::Parameters::SearchAfter
      ...
      # @see Crunchy::Search::Response#objects
      # @see Crunchy::Search::Scrolling#scroll_objects
      ...
      #   @see Crunchy::Search::Parameters::ScriptFields
      ...
      #   @see Crunchy::Search::Parameters::IndicesBoost
      ...
      #   @see Crunchy::Search::Parameters::Rescore
      ...
      #   @see Crunchy::Search::Parameters::Highlight
      ...
      #   @see Crunchy::Search::Parameters::Suggest
      ...
      #   returns {Crunchy::Search::Response#suggest} contents.
      #
      #   @example
      #     PlacesIndex.suggest(names: {text: 'tring out Elasticsearch'}).suggest
      #   @see Crunchy::Search::Response#suggest
      #   @return [Hash]
      ...
      #   @see Crunchy::Search::Parameters::Aggs
      ...
      # @overload aggs
      #   Without value provided, it performs the request and
      #   returns {Crunchy::Search::Response#aggs} contents.
      #
      #   @example
      #     PlacesIndex.aggs(avg_population: {avg: {field: :population}}).aggs
      #   @see Crunchy::Search::Response#aggs
      #   @return [Hash]
      ...
      # @see Crunchy::Search::Parameters#merge
      # @param other [Crunchy::Search::Request] scope to merge
      # @return [Crunchy::Search::Request] new scope
      def merge(other)
      ...
      # @!method or(other)
      #   Takes `query`, `filter`, `post_filter` from the passed scope
      #   and performs {Crunchy::Search::QueryProxy#or} operation for each
      #   of them. Unlike merge, every other parameter is kept unmerged
      #   (values from the first scope are used in the result scope).
      #
      #   @see Crunchy::Search::QueryProxy#or
      #   @example
      #     scope1 = PlacesIndex.filter(term: {name: 'Moscow'}).query(match: {name: 'London'})
      #     scope2 = PlacesIndex.filter.not(term: {name: 'Berlin'}).query(match: {name: 'Washington'})
      #     scope1.or(scope2)
      ...
      # @!method not(other)
      #   Takes `query`, `filter`, `post_filter` from the passed scope
      #   and performs {Crunchy::Search::QueryProxy#not} operation for each
      #   of them. Unlike merge, every other parameter is kept unmerged
      #   (values from the first scope are used in the result scope).
      #
      #   @see Crunchy::Search::QueryProxy#not
      #   @example
      #     scope1 = PlacesIndex.filter(term: {name: 'Moscow'}).query(match: {name: 'London'})
      #     scope2 = PlacesIndex.filter.not(term: {name: 'Berlin'}).query(match: {name: 'Washington'})
      #     scope1.not(scope2)
      ...
      def count
        if performed?
          ...
          Crunchy.client.count(only(WHERE_STORAGES).render)['count']
        end
      ...
      #
      #   @return [Crunchy::Index] result document
      #
      ...
      #   @return [Array<Crunchy::Index>] result document collection
      ...
      #
      # @raise [Crunchy::DocumentNotFound] in case of any document is missing
      # @overload find(id)
      ...
      #   @return [Array<Crunchy::Index>] result documents
      def find(*ids)
        ...
        if ids.size != results.size
          ...
          raise Crunchy::DocumentNotFound, "Could not find documents for ids: #{missing_ids.to_sentence}"
        end
      ...
      def delete_all(refresh: true, wait_for_completion: nil, requests_per_second: nil, scroll_size: nil)
        ...
        ActiveSupport::Notifications.instrument 'delete_query.crunchy', notification_payload(request: request_body) do
          request_body[:body] = {query: {match_all: {}}} if request_body[:body].empty?
          Crunchy.client.delete_by_query(request_body)
        end
      end
    ...
    private
      ...
      def perform(additional = {})
        ...
        ActiveSupport::Notifications.instrument 'search_query.crunchy', notification_payload(request: request_body) do
          Crunchy.client.search(request_body)
        rescue Elasticsearch::Transport::Transport::Errors::NotFound
          {}
        end
      end
