module Crunchy
  class Index
    module Import
      ...
      #
      # @see Crunchy::Index::Import::ClassMethods#import
      class Routine
        BULK_OPTIONS = %i[
          suffix bulk_size
        ...
        DEFAULT_OPTIONS = {
          ...
          batch_size: Crunchy::Index::Adapter::Base::BATCH_SIZE
        }.freeze
        ...
        # @param options [Hash] import options, see {Crunchy::Index::Import::ClassMethods#import}
        def initialize(index, **options)
          @index = index
          @options = options
          @options.reverse_merge!(@index._default_import_options)
          @options.reverse_merge!(journal: Crunchy.configuration[:journal])
        ...
        def create_indexes!
          Crunchy::Stash::Journal.create if @options[:journal] && !Crunchy.configuration[:skip_journal_creation_on_import]
          return if Crunchy.configuration[:skip_index_creation_on_import]
